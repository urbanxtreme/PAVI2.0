document.addEventListener("DOMContentLoaded", () => {
  ...
  const billData = {
    water: {
      ...
      estimated: 48.5,
      history: [
        { month: "Aug", amount: 42.3 },
        { month: "Sep", amount: 43.8 },
        { month: "Oct", amount: 44.5 },
        { month: "Nov", amount: 45.2 },
        { month: "Dec", amount: 45.9 },
        { month: "Jan", amount: 46.5 },
      ],
      prediction: [
        { month: "Feb", amount: 48.5 },
    ...
    electricity: {
      ...
      estimated: 115.3,
      history: [
        { month: "Aug", amount: 118.2 },
        { month: "Sep", amount: 119.4 },
        { month: "Oct", amount: 120.1 },
        { month: "Nov", amount: 120.8 },
        { month: "Dec", amount: 119.9 },
        { month: "Jan", amount: 118.5 },
      ],
      prediction: [
        { month: "Feb", amount: 115.3 },
        { month: "Mar", amount: 114.5 },
      ],
    },
  };
  ...
  function createBillGraph(history, prediction, type) {
    ...
    const labels = [
      ...
      ...prediction.map((item) => item.month),
    ];
    const historicalData = history.map((item) => item.amount);
    const predictionData = Array(history.length)
      .fill(null)
      .concat(prediction.map((item) => item.amount));
